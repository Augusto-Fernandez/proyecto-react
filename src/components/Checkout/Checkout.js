...
const Checkout = () =>{
    ...
    const createOrder = async () =>{ /*114) crea funcion que hace ordenes y mete el objectOrder adentro para que se genere cuando se pida la orden*/
        ...
        docs.forEach(doc =>{
            ...
            const productsQuantity = productsAddedToCart.qtty /*121) cantidad de productos que agregó el usuario al carrito VER SI LO TENGO QUE CAMBIAR A QTTY*/
        ...
        if(outOfStock.length===0){ /*126) si no hay productos fuera de stock */
            ...
            const {id} =orderAdded /*130) obtiene el id de la orden */
            console.log(id)
        }
    }
